...
MAXIMUM_IMAGE_NUMBER = 100000 # If the directory has more than this number, stop crawling
...
for ID in lst:
    try:
        ...
        for work_no in range(0, total_works):
            if num_files > MAXIMUM_IMAGE_NUMBER:
            ...
            if illust.book_style != "none":
                debug_print("skip: book_style")
                skip_this_work = True
